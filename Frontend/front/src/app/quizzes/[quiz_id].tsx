// //app/quizzes/[quiz_id].tsx (Dynamic route for quiz details)

// "use client";

// import { useEffect, useState } from "react";
// import { useRouter } from "next/router"; // To access the URL parameters

// const QuizDetailPage = () => {
//   const router = useRouter();
//   const { quiz_id } = router.query; // Get quiz_id from URL
