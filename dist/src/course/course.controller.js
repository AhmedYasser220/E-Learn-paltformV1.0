...
let CourseController = class CourseController {
    ...
    async getCourseVersions(course_Id) {
        try {
            ...
            throw new common_1.InternalServerErrorException('Failed to fetch course versions');
        }
    }
};
exports.CourseController = CourseController;
__decorate([
    (0, common_1.Put)(':course_Id'),
...
__decorate([
    (0, common_1.Get)(':course_Id/versions'),
    __param(0, (0, common_1.Param)('course_Id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CourseController.prototype, "getCourseVersions", null);
